...
--NOTE: Unit is useful (think of a void function in Java) 
...
public class HelloWorld {
    public static void main(String[] args) { //NOTE: when main runs it returns the unit type / void
...
| n => _
--NOTE: cannot return a value of type Empty, they is an uninhabited type / false type 
--there is no way to build an empty object 
...
def empty2nat : Empty → Nat --NOTE: this function can never be called 
| e => nomatch e 
