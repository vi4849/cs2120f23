...
[inductive delcaration]
inductive Sandwich: Type
| mk (x: Bread × (Cheese ⊕ Spread))

-/

--structure declaration
structure Sandwich : Type := 
(x: Bread × (Cheese ⊕ Spread))
...
def jam_sandwich : Sandwich := Sandwich.mk (wheat, (Sum.inr jam))
